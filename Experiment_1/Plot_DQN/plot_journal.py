...
path = "../DQN_fit100_act100/"
filename = "DQN_fit100_act100"
filename_loss = "DQN_fit100_act100_loss(f"
filename_re = "DQN_fit100_act100_rewards(f"
...
plt.suptitle("Fit100-Act100 Environment", fontsize=16, fontweight='bold')
