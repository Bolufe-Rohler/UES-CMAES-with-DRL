from env_resdisnew60_cnvRan5 import Env_Resdisnew60_cnvRan5
...
eval_py_env = Env_Resdisnew60_cnvRan5(func_num, dim=dim)
...
for _ in range(10):
    get_new_action = 3  # np.array(np.random.randint(0, 4))  # environment.step(get_new_action)
